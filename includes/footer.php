		...
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--info">
				...
				<ul class="footer-nav__list">
					...
					<li class="footer-nav__item">
						<a href="about.php" class="footer-nav__link">Site map</a>
					</li>
				</ul>
			</div>
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:+92 3097300881">+92 3097300881</a>
				</div>
				<div class="email">
					Email:
					<a href="mailto:aliwasif12828@gmail.com" class="email__addr">contact@avenue.com</a>
				</div>
			</div>
